...
export type CountryInformationQueryVariables = Exact<{ [key: string]: never; }>;
...
export type CountryInformationQuery = (
  ...
  & { Country?: Maybe<Array<Maybe<(
    { __typename?: 'Country' }
    & Pick<Country, '_id' | 'name' | 'capital' | 'area' | 'population'>
  )>>> }
);


export const CountryInformationDocument = gql`
...
export const CountryInformationComponent = (props: Omit<Urql.QueryProps<CountryInformationQuery, CountryInformationQueryVariables>, 'query'> & { variables?: CountryInformationQueryVariables }) => (
  <Urql.Query {...props} query={CountryInformationDocument} />
);


export function useCountryInformationQuery(options: Omit<Urql.UseQueryArgs<CountryInformationQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<CountryInformationQuery>({ query: CountryInformationDocument, ...options });
};